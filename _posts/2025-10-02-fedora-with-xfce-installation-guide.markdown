...
sudo dnf install firefox mousepad ristretto thunar-archive-plugin xfce4-notifyd xfce4-screenshooter gvfs-mtp google-noto-fonts-all xarchiver unzip unrar network-manager-applet tumbler pulseaudio pavucontrol xfce4-pulseaudio-plugin --setopt=install_weak_deps=False
