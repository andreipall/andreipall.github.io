...
date:   2021-07-10 12:46:56
categories: Linux
description: Bash Scripting
keywords: [Andrei Pall, blog, freebsd, linux, framework]
excerpt: Bash is an sh-compatible shell that incorporates useful features from the Korn shell (ksh) and the C shell (csh). It offers functional improvements over sh for both programming and interactive use. In addition, most sh scripts can be run by Bash without modification.
---
Getting started
---------------
{: .-three-column}
